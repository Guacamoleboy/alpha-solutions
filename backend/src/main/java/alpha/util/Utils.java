...
public class Utils {
    ...
    public static String getPropertyValue(String propName, String resourceName) {
        ...
        try (InputStream is = Utils.class.getClassLoader().getResourceAsStream(resourceName)) {
            if (is == null) {
                throw new RuntimeException(String.format("Resource file %s not found in classpath.", resourceName));
            }
            ...
            if (value != null) {
                ...
                throw new RuntimeException(String.format("Property %s not found in %s", propName, resourceName));
            }
        } catch (IOException ex) {
            ex.printStackTrace();
            throw new RuntimeException(String.format("Could not read property %s. Did you remember to build the project with MAVEN?", propName), ex);
        }
    }
